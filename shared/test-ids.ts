...
export const TESTID = {
  ...
  RULES: {
    ...
    POOL_IMPORT_BUTTON: 'rules-import-button',
    POOL_COUNT: 'rules-pool-count',
    ...
    EDITOR_TOGGLE_ACTIVE_BUTTON: 'rules-editor-toggle-active-button',
    EDITOR_CANCEL_BUTTON: 'rules-editor-cancel-button',
...
export const testId = {
  ...
  // Rule Pool Item Actions
  rulesPoolItemMore: (id: string) => `rules-pool-item-${id}-more`,
  rulesPoolItemEdit: (id: string) => `rules-pool-item-${id}-edit`,
  rulesPoolItemDelete: (id: string) => `rules-pool-item-${id}-delete`,
  rulesPoolItemStatusActive: (id: string) => `rules-pool-item-${id}-status-active`,
  rulesPoolItemStatusInactive: (id: string) => `rules-pool-item-${id}-status-inactive`,
